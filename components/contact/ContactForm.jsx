...
export default function ContactForm() {
  ...
  return (
    <div className="lg:col-span-3 bg-white p-8 md:p-12 rounded-[2rem] border border-[#e8e4de] shadow-lg relative overflow-hidden">
      ...
      {isSuccess ? (
        <div className="h-full flex flex-col items-center justify-center text-center py-12 relative z-10">
          ...
          <p className="text-[var(--color-text-secondary)] mb-8 max-w-md mx-auto">
            Thank you for reaching out. One of our packaging experts will get
            back to you shortly.
          </p>
